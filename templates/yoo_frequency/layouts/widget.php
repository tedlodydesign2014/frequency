...
// Set default panel
if ($panel == '' && in_array($widget->position, array('top-a', 'top-b', 'bottom-a', 'bottom-b', 'bottom-c', 'main-top', 'main-bottom', 'sidebar-a', 'sidebar-b'))) {
    $panel = $this['config']->get("panel_default.{$widget->position}.panel", '');
}
// Set panel for specific positions
else if (in_array($widget->position, array('headerbar-l', 'headerbar-r', 'toolbar-r' ,'toolbar-l', 'footer', 'offcanvas'))) {
	$panel = 'uk-panel';
}
...
// Set title
if (in_array($widget->position, array('headerbar-l', 'headerbar-r', 'toolbar-r' ,'toolbar-l', 'footer'))) {
	$title = '';
