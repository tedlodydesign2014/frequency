...
foreach ($blocks as $block) {
    ...
    $block_classes[$position] = array();

    if ($this['config']->get("block.{$block}.block_divider", false)) {
        $block_classes[$block][] = ' tm-block-divider';
        $block_classes[$block] = implode(" ", $block_classes[$block]);
    }
